...
select * from products where categoryCode= 100;

select * from products where productPrice between 750 and 1300;

select productName from products;
select productName from products where categoryCode = 102;

select products.productName, products.productPrice, categories.categoryName
from products
join categories on products.categoryCode = categories.categoryCode;
