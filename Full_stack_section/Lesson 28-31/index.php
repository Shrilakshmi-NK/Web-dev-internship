  ...
  <div class="employees"> 
    ...
    <div class="employee-list"> 
      <li> 
        ...
        <span> <div class="employment-details" id="employee1-details"> <span class="name-format">Ashton</span>
...
<li> 
  <div class="employee-card" id="employee1">
    <img class="user-img" src="img/user3.jpg" alt=""> 
    <span> 
  ...
  <li> 
    <div class="employee-card" id="employee1"> 
      <img class="user-img" src="img/joe.jpg" alt=""> 
      <span> 
        <div class="employment-details" id="employee1-details"> 
  ...
  <li> 
    <div class="employee-card" id="employee1"> 
      <img class="user-img" src="img/user2.jpg" alt=""> 
      <span> 
        <div class="employment-details" id="employee1-details"> 
